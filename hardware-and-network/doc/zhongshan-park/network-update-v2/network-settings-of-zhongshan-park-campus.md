...
| :--: | :--: | :--: | :--: | :--: |
| 1 | 机房1号机柜第1个 | H3C ER8300 G2-X | 10.0.1.2/24 | 学校网络连接电信宽带，每个VLAN均有IP。例如: 10.0.10.2 |
| 2 | 机房1号机柜第2个 | H3C ER5200 | 192.168.1.1/24 | 理事长室单独连接一根电信宽带 |

* ER8300G2-X设置
  * WAN1: 连接电信网关
  * LAN1：连接H3C S5500核心交换机
  * VLAN / IP
  ...
  * Trunk口设置
    ...
    | LAN ID | PVID | Permitted VLAN IDs |
    | :--: | :--: | :--: |
    | 1 | 1 | 1-3,5-7,10,20-22,100 |
  * 静态路由
    
    | 目的地址 | 子网掩码 | 下一跳地址 | 出接口 |
    | :--: | :--: | :--: | :--: |
    | 10.0.1.0 | 255.255.255.0 | 10.0.100.1 | VLAN100 |
    | 10.0.2.0 | 255.255.255.0 | 10.0.100.1 | VLAN100 |
    | 192.168.1.0 | 255.255.255.0 | 10.0.100.1 | VLAN100 |
    | 192.168.30.0 | 255.255.255.0 | 10.0.100.1 | VLAN100 |
    | 10.0.6.0 | 255.255.255.0 | 10.0.100.1 | VLAN100 |
    | 10.0.10.0 | 255.255.255.0 | 10.0.100.1 | VLAN100 |
    | 10.0.20.0 | 255.255.255.0 | 10.0.100.1 | VLAN100 |
    | 10.0.21.0 | 255.255.255.0 | 10.0.100.1 | VLAN100 |
    | 10.0.22.0 | 255.255.255.0 | 10.0.100.1 | VLAN100 |
...
| 2 | 10.0.2.0/24 | AP | Yes | 10.0.2.1 - 10.0.2.20 |
| 3 | 192.168.1.0/24 | 旧监控摄像头，录像机（教室） | No | n/a |
| 5 | 192.168.30.0/24 | 新监控摄像头，录像机（走道）+ 213,313教室 | No | n/a |
